...
- Out of scope (deferred, filed as follow-ups): a Settings-screen UI for the 5 new fields ([#37](../../../issues/37) — `Settings.tsx` hand-renders each field and none was added for this issue); moving bucket state to a shared store for multi-replica correctness ([#38](../../../issues/38), see above).
